...
class User 
{
	...
	function __construct($user,$display,$pass,$email,$level = 1, $parent = 0)
	{
		//added by faizshukri
		$this->user_parent = $parent;
		$this->level = $level;
		//end added by faiz
	...
	public function userCakeAddUser()
	{
		...
		if($this->status)
		{
			...
			if(!$this->mail_failure)
			{
				...
				$stmt->bind_param("sssssii", $this->username, $this->displayname, $secure_pass, $this->clean_email, $this->activation_token, $this->user_active, $this->user_parent);
				$stmt->execute();
